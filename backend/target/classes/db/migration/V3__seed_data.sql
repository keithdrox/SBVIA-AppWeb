...
('Autopista Norte Lluvia', 'Conducción a alta velocidad bajo condiciones de lluvia intensa y baja visibilidad.', 'AUTOPISTA', 4, 'LLUVIA', 'MEDIA', true, NOW(), NOW()),
('Vía Rural Nocturna', 'Camino de un solo carril por sentido, sin iluminación artificial y posibles obstáculos.', 'RURAL', 2, 'NOCHE', 'BAJA', true, NOW(), NOW()),
('Avenida Principal Niebla', 'Condiciones de niebla densa en zona comercial con alto tránsito.', 'MIXTA', 5, 'NIEBLA', 'ALTA', true, NOW(), NOW());
