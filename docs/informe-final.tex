...
Los resultados se clasifican en tres grupos. Se consideran cumplidos el umbral de latencia caliente en las corridas disponibles, la tasa de error observada, el objetivo SUS, las coberturas de líneas y ramas y los controles funcionales documentados. Se consideran parciales el protocolo de cinco corridas, la comparación estadística frío/caliente, la descarga completa de certificado y los objetivos de Lighthouse. Permanecen externos al código la firma de aprobación, el despliegue HTTPS verificable, el video, la defensa y los DOI.
