...
| **OBS-06** | Entrega 1B | C6 | Añadir la tabla de métricas de rendimiento con tiempos promedio y P95 con y sin caché Redis, y el cálculo del speedup. | Existen 3 corridas calientes y 10 ciclos secuenciales frío/caliente con speedup aproximado de 1.2x; faltan 2 corridas y un protocolo pareado homogéneo. | `docs/mediciones/perf/` | Parcial |
